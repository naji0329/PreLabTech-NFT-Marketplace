...
contract TokenSwap is Context, Ownable {
    ...
    constructor() public {
        ...
        CBFI = IERC20(0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984);
    }
    ...
    function swapETHtoWEth() public payable {
        ...
        uint256 tokeAmontOfContract = CBFI.balanceOf(address(this));
        ...
        path1[0] = 0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984;
    ...
    function swapTokenToWEth() public payable {
        uint256 tokeAmontOfContract = CBFI.balanceOf(address(this));
