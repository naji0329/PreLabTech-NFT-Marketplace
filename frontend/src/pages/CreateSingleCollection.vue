                        ...
                        <form action="#" class="form-create mb-5 mb-lg-0">
                            ...
                            <div class="form-item mb-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-s1" placeholder="Enter collection name" v-model="contractData.name">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-s1" placeholder="Enter collection name" v-model="contractData.symbol">
                                    <p class="px-3 text-red"><small v-if="errors.name">{{errors.symbol}}</small></p>
                                </div>
                                <div class="mb-4">
                                    <label class="mb-2 form-label">Description <small>(optional)</small></label>
                                    <textarea name="message" class="form-control form-control-s1" placeholder="Spread some words about your token collection" v-model="contractData.description"></textarea>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input type="text" class="form-control form-control-s1" placeholder="Enter short url" v-model="contractData.shortUrl">
                                    </div>
        ...
        function fileUpload(selector) {
            ...
            if(elem.length > 0) {
                ...
                item.addEventListener("change", function(){
                    ...
                    alert(extTxt + " file type not allowed, Please upload jpg, png, gif.");
